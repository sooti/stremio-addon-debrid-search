...
async function combineAndMarkResults(apiKey, personalFiles, externalSources) {
    const sourceNames = ['Jackett', 'Torrentio', 'Zilean', 'Comet', 'StremThru'];
    const enabledFlags = [JACKETT_ENABLED, TORRENTIO_ENABLED, ZILEAN_ENABLED, COMET_ENABLED, STREMTHRU_ENABLED];
