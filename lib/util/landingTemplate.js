...
@media (max-width: 768px) {
    ...
    /* Hide page 2 by default on mobile */
    #wizardPage2 {
        display: none;
    }
...
function landingTemplate(manifest, config = {}) {
	...
	<form class="pure-form" id="mainForm">
		...
		<div class="wizard-page" id="wizardPage1">
			<div class="wizard-header mobile-only">
				...
				<p style="text-align: center; margin: 1em 0 0.5em; opacity: 0.8; font-size: 0.9rem;">Step 1 of 2: Add Services</p>
			</div>
			...
			<div class="wizard-navigation mobile-only">
				<button type="button" class="wizard-btn wizard-btn-next" id="nextToPage2">Next: Optional Settings →</button>
			</div>
		</div>

		<!-- Wizard Page 2: Optional Settings -->
		<div class="wizard-page" id="wizardPage2">
			<div class="wizard-header mobile-only">
				...
				<p style="text-align: center; margin: 1em 0 0.5em; opacity: 0.8; font-size: 0.9rem;">Step 2 of 2: Optional Settings</p>
				<p style="text-align: center; margin: 0 0 1.5em; padding: 0.8em; background: rgba(100, 255, 218, 0.1); border-radius: 8px; font-size: 0.85rem; color: #64ffda; border: 1px solid rgba(100, 255, 218, 0.2);">
					These settings are optional. You can scroll down and install now, or customize your experience first.
				</p>
			</div>

		<hr class="separator desktop-only" id="scrapersSection">

		<div class="form-element" id="torrentScrapersSection">
			<label class="label-to-top">Torrent Scrapers (optional)</label>
			<p style="opacity: 0.7; font-size: 0.9rem; margin-bottom: 1em;">Select torrent scrapers to search. By default, all scrapers are enabled. More scrapers = more results but slower response times.</p>
			<details class="mobile-collapsible">
				<summary style="cursor: pointer; padding: 0.8em; background: #112240; border: 1px solid #233554; border-radius: 5px; margin-bottom: 0.5em; list-style: none; display: flex; justify-content: space-between; align-items: center;">
					<span>Select Torrent Scrapers</span>
					<span class="arrow">▼</span>
				</summary>
				<div style="display: grid; grid-template-columns: 1fr; gap: 0.5em; margin-bottom: 0.5em; padding: 0.5em 0;">
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="jackett" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Jackett (Meta-Tracker)
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="1337x" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">1337x
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="torrent9" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Torrent9
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="btdig" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">BTDigg
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="snowfl" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Snowfl
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="magnetdl" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">MagnetDL
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="wolfmax4k" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Wolfmax4K (Spanish)
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="bludv" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">BluDV (Portuguese)
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="bitmagnet" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Bitmagnet
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="scraper-checkbox" value="knaben" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Knaben
					</label>
				</div>
			</details>
			<div id="torrentScrapersCheckboxes" class="desktop-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 0.5em; margin-bottom: 0.5em;">
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="jackett" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Jackett (Meta-Tracker)
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
			...
			<select id="Scrapers" name="Scrapers" class="full-width" multiple style="display: none;">
				...
				<option value="knaben" selected>Knaben</option>
			</select>
			<p style="opacity: 0.7; font-size: 0.9rem; margin-top: 0.5em;">Uncheck any scrapers you don't want to use. Selecting multiple scrapers may increase search time.</p>
		</div>
		...
		<div class="form-element" id="indexerScrapersSection">
			...
			<details class="mobile-collapsible">
				<summary style="cursor: pointer; padding: 0.8em; background: #112240; border: 1px solid #233554; border-radius: 5px; margin-bottom: 0.5em; list-style: none; display: flex; justify-content: space-between; align-items: center;">
					<span>Select Indexer Scrapers</span>
					<span class="arrow">▼</span>
				</summary>
			<div style="display: grid; grid-template-columns: 1fr; gap: 0.5em; margin-bottom: 0.5em; padding: 0.5em 0;">
				${process.env.ZILEAN_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="zilean" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Zilean (Direct Indexer Access)</label>' : ''}
				${process.env.TORRENTIO_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="torrentio" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Torrentio (Direct Indexer Access)</label>' : ''}
				${process.env.COMET_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="comet" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Comet (Direct Indexer Access)</label>' : ''}
				${process.env.STREMTHRU_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="stremthru" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">StremThru (Direct Indexer Access)</label>' : ''}
			</div>
			</details>
			<div id="indexerScrapersCheckboxes" class="desktop-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 0.5em; margin-bottom: 0.5em;">
				${process.env.ZILEAN_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="zilean" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Zilean (Direct Indexer Access)</label>' : ''}
				${process.env.TORRENTIO_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="torrentio" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Torrentio (Direct Indexer Access)</label>' : ''}
				${process.env.COMET_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="comet" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Comet (Direct Indexer Access)</label>' : ''}
				${process.env.STREMTHRU_ENABLED === 'true' ? '<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;"><input type="checkbox" class="indexer-scraper-checkbox" value="stremthru" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">StremThru (Direct Indexer Access)</label>' : ''}
			</div>
			<select id="IndexerScrapers" name="IndexerScrapers" class="full-width" multiple style="display: none;">
				${process.env.ZILEAN_ENABLED === 'true' ? '<option value="zilean" selected>Zilean (Direct Indexer Access)</option>' : ''}
		...
		<hr class="separator">
				...
				<div class="form-element">
			<label class="label-to-top">Filter by Languages (optional)</label>
			<p style="opacity: 0.7; font-size: 0.9rem; margin-bottom: 1em;">Select one or more languages. If none are selected, no language filter is applied. Selecting English keeps English or unlabeled.</p>
			<details class="mobile-collapsible">
				<summary style="cursor: pointer; padding: 0.8em; background: #112240; border: 1px solid #233554; border-radius: 5px; margin-bottom: 0.5em; list-style: none; display: flex; justify-content: space-between; align-items: center;">
				...
				<div style="display: grid; grid-template-columns: 1fr; gap: 0.5em; margin-bottom: 0.5em; padding: 0.5em 0;">
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="english" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇬🇧 English
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="spanish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇪🇸 Spanish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="latino" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇲🇽 Latino
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="french" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇫🇷 French
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="german" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇩🇪 German
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="italian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇹 Italian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="portuguese" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇵🇹 Portuguese
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="russian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇷🇺 Russian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="japanese" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇯🇵 Japanese
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="korean" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇰🇷 Korean
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="chinese" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇨🇳 Chinese
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="taiwanese" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇹🇼 Taiwanese
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="hindi" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇳 Hindi
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="tamil" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇳 Tamil
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="telugu" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇳 Telugu
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="arabic" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇸🇦 Arabic
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="turkish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇹🇷 Turkish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="dutch" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇳🇱 Dutch
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="polish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇵🇱 Polish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="czech" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇨🇿 Czech
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="hungarian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇭🇺 Hungarian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="romanian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇷🇴 Romanian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="bulgarian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇧🇬 Bulgarian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="serbian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇷🇸 Serbian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="croatian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇭🇷 Croatian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="ukrainian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇺🇦 Ukrainian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="greek" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇬🇷 Greek
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="swedish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇸🇪 Swedish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="norwegian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇳🇴 Norwegian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="danish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇩🇰 Danish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="finnish" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇫🇮 Finnish
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="hebrew" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇱 Hebrew
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="persian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇷 Persian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="thai" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇹🇭 Thai
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="vietnamese" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇻🇳 Vietnamese
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="indonesian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇮🇩 Indonesian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="malay" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇲🇾 Malay
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="lithuanian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇱🇹 Lithuanian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="latvian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇱🇻 Latvian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="estonian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇪🇪 Estonian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="slovakian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇸🇰 Slovakian
					</label>
					<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
						<input type="checkbox" class="language-checkbox" value="slovenian" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇸🇮 Slovenian
					</label>
				</div>
			</details>
			<div id="languageCheckboxes" class="desktop-checkboxes" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 0.5em; margin-bottom: 0.5em;">
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="language-checkbox" value="english" style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">🇬🇧 English
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
	...
	<div id="installButtons">
		...
		<div class="wizard-navigation mobile-only" style="margin-top: 1em;">
			<button type="button" class="wizard-btn wizard-btn-back" id="backToPage1">← Back to Services</button>
		</div>
	</div>
	`
	...
	const syncCheckboxesToSelect = (checkboxClass, selectElement) => {
		const checkboxes = document.querySelectorAll('.' + checkboxClass);
		checkboxes.forEach(checkbox => {
			checkbox.addEventListener('change', () => {
				const option = selectElement.querySelector('option[value="' + checkbox.value + '"]');
				if (option) {
	...
	// Function to sync select with checkboxes
	const syncSelectToCheckboxes = (selectElement, checkboxClass) => {
		const checkboxes = document.querySelectorAll('.' + checkboxClass);
	...
	// Setup checkbox sync
	syncCheckboxesToSelect('scraper-checkbox', scrapersSelect);
	if (indexerScrapersSelect) {
		syncCheckboxesToSelect('indexer-scraper-checkbox', indexerScrapersSelect);
	}
...
const existingServices = ${JSON.stringify(config.DebridServices || (config.DebridProvider ? [{ provider: config.DebridProvider, apiKey: config.DebridApiKey }] : [{ provider: process.env.DEFAULT_DEBRID_SERVICE || 'RealDebrid', apiKey: '' }]))};
	...
	const updateScraperVisibility = () => {
		...
		// Check if there's at least one debrid service (not Usenet, HomeMedia, or httpstreaming)
		const rows = container.querySelectorAll('.service-row');
		let hasDebridService = false;

		rows.forEach(row => {
			const provider = row.querySelector('.debrid-provider')?.value;
			if (provider && provider !== 'Usenet' && provider !== 'HomeMedia' && provider !== 'httpstreaming' && provider !== 'PersonalCloud') {
...
const createServiceRow = (provider = '${process.env.DEFAULT_DEBRID_SERVICE || 'RealDebrid'}', apiKey = '', extraConfig = {}) => {
	...
	if (languagesSelect) {
		...
		// Sync checkboxes with select state
		syncCheckboxesToSelect('language-checkbox', languagesSelect);
		syncSelectToCheckboxes(languagesSelect, 'language-checkbox');
	}

	// Initialize scraper selection
	const scrapers = ${JSON.stringify(config.Scrapers) || '[]'};
	// If no scrapers in config, select all by default
	const hasScrapersConfig = scrapers && scrapers.length > 0;
	for (const option of scrapersSelect.options) {
		if (hasScrapersConfig) {
			option.selected = scrapers.includes(option.value);
		}
		// else: options are already selected by default in HTML
	}
	// Sync checkboxes with select state
	syncSelectToCheckboxes(scrapersSelect, 'scraper-checkbox');
	scrapersSelect.addEventListener('change', () => {
		syncSelectToCheckboxes(scrapersSelect, 'scraper-checkbox');
		updateLink();
	});
	...
	if (indexerScrapersSelect) {
		...
		// Sync checkboxes with select state
		syncSelectToCheckboxes(indexerScrapersSelect, 'indexer-scraper-checkbox');
		indexerScrapersSelect.addEventListener('change', () => {
			syncSelectToCheckboxes(indexerScrapersSelect, 'indexer-scraper-checkbox');
			updateLink();
		});
	}
	...
	if (nextToPage2Btn && backToPage1Btn) {
