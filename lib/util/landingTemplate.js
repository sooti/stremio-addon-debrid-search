...
<!--                <option value="AllDebrid">AllDebrid</option>
		...
		<div class="form-element">
			<label class="label-to-top" for="LangPref">Preferred torrent languages (comma separated)</label>
			<input type="text" id="LangPref" name="LangPref" class="full-width" placeholder="e.g. ita,eng,multi" />
			<p style="font-size:0.8rem; opacity:0.7; margin-top:0.4em;">Esempi: <code>ita</code> | <code>ita,eng,multi</code> | <code>eng</code> | <code>por,eng</code>. Lascia vuoto per nessun filtro.</p>
		</div>
...
<!--		<div class="form-element checkbox-container">
	...
	document.getElementById('LangPref').value = "${config.LangPref || ''}";
