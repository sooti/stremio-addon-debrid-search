...
@media (max-width: 768px) {
    ...
    /* Show checkboxes on mobile, hide select elements */
    #Scrapers {
        display: none !important;
    }

    #torrentScrapersCheckboxes {
...
function landingTemplate(manifest, config = {}) {
	...
	<form class="pure-form" id="mainForm">
		...
		<div class="form-element">
			...
			<div id="torrentScrapersCheckboxes" style="display: none; flex-direction: column; gap: 0.5em; margin-bottom: 0.5em;">
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="jackett" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Jackett (Meta-Tracker)
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="1337x" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">1337x
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="torrent9" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Torrent9
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="btdig" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">BTDigg
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="snowfl" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Snowfl
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="magnetdl" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">MagnetDL
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="wolfmax4k" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Wolfmax4K (Spanish)
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="bludv" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">BluDV (Portuguese)
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
					<input type="checkbox" class="scraper-checkbox" value="bitmagnet" checked style="margin-right: 8px; accent-color: #64ffda; width: 1.2em; height: 1.2em;">Bitmagnet
				</label>
				<label style="display: flex; align-items: center; font-size: 0.9rem; cursor: pointer;">
			...
			<select id="Scrapers" name="Scrapers" class="full-width" multiple>
				<option value="jackett" selected>Jackett (Meta-Tracker)</option>
				<option value="1337x" selected>1337x</option>
				<option value="torrent9" selected>Torrent9</option>
				<option value="btdig" selected>BTDigg</option>
				<option value="snowfl" selected>Snowfl</option>
				<option value="magnetdl" selected>MagnetDL</option>
				<option value="wolfmax4k" selected>Wolfmax4K (Spanish)</option>
				<option value="bludv" selected>BluDV (Portuguese)</option>
				<option value="bitmagnet" selected>Bitmagnet</option>
		...
		<div class="form-element">
			...
			<div id="indexerScrapersCheckboxes" style="display: none; flex-direction: column; gap: 0.5em; margin-bottom: 0.5em;">
	...
	// Mobile detection and checkbox/select switching
	const isMobile = window.innerWidth <= 768;
	const scrapersSelect = document.getElementById('Scrapers');
	const scrapersCheckboxDiv = document.getElementById('torrentScrapersCheckboxes');
	const indexerScrapersSelect = document.getElementById('IndexerScrapers');
	const indexerScrapersCheckboxDiv = document.getElementById('indexerScrapersCheckboxes');
	...
	// Show/hide appropriate UI based on screen size
	if (isMobile) {
		scrapersSelect.style.display = 'none';
		scrapersCheckboxDiv.style.display = 'flex';
		if (indexerScrapersSelect && indexerScrapersCheckboxDiv) {
			indexerScrapersSelect.style.display = 'none';
			indexerScrapersCheckboxDiv.style.display = 'flex';
		}
	}
