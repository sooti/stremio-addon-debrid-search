...
<!--                <option value="AllDebrid">AllDebrid</option>
		...
		<div class="form-element">
			...
			<p style="font-size:0.8rem; opacity:0.7; margin-top:0.4em;">Example: <code>ita</code> | <code>ita,eng,multi</code> | <code>eng</code> | <code>por,eng</code>. Leave Empty for no filter.</p>
		</div>
