        ...
        <main class="flex-1 custom-bg pb-24 lg:pb-8 relative">
            ...
            <div class="p-4 lg:p-8 max-w-5xl mx-auto">
                ...
                <div id="dashboard-section" class="section-content active">
                    ...
                    <div class="hidden md:block">
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                            <div class="bg-[#1e293b] rounded-2xl p-6 flex flex-col items-start shadow-lg">
                                <div class="flex items-center gap-3 mb-2">
                                    <i class="fas fa-plug text-[#4ac4b1] text-xl"></i>
                                    <span class="text-lg font-semibold text-white">Services</span>
                                </div>
                                <span class="text-3xl font-bold text-white mt-2" id="service-count">${config.DebridServices ? config.DebridServices.length : 0}</span>
                            </div>
                            <div class="bg-[#1e293b] rounded-2xl p-6 flex flex-col items-start shadow-lg">
                                <div class="flex items-center gap-3 mb-2">
                                    <i class="fas fa-check-circle text-[#4ac4b1] text-xl"></i>
                                    <span class="text-lg font-semibold text-white">Status</span>
                                </div>
                                <span class="inline-flex items-center gap-2 mt-2">
                                    <span class="w-3 h-3 bg-green-400 rounded-full animate-pulse"></span>
                                    <span class="text-white font-bold text-3xl">Active</span>
                                </span>
                            </div>
                            <div class="bg-[#1e293b] rounded-2xl p-6 flex flex-col items-start shadow-lg">
                                <div class="flex items-center gap-3 mb-2">
                                    <i class="fas fa-language text-[#4ac4b1] text-xl"></i>
                                    <span class="text-lg font-semibold text-white">Languages</span>
                                </div>
                                <span class="text-3xl font-bold text-white mt-2" id="language-count">${config.Languages ? config.Languages.length : 0}</span>
                            </div>
                            <div class="bg-[#1e293b] rounded-2xl p-6 flex flex-col items-start shadow-lg">
                                <div class="flex items-center gap-3 mb-2">
                                    <i class="fas fa-code-branch text-[#4ac4b1] text-xl"></i>
                                    <span class="text-lg font-semibold text-white">Version</span>
                                </div>
                                <span class="text-3xl font-bold text-white mt-2">${manifest.version || '1.4.0'}</span>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div class="md:col-span-2 bg-[#1e293b] rounded-2xl p-6 shadow-lg">
                                <h2 class="text-xl font-semibold text-white mb-4 flex items-center gap-2">
                                    <i class="fas fa-history text-[#8f8f8f]"></i>
                                    Sootio Changelogs
                                </h2>
                                <ul class="space-y-3">
                                    <li>
                                        <div class="flex items-start gap-3">
                                            <span class="w-2 h-2 mt-2 bg-[#38bdf8] rounded-full flex-shrink-0"></span>
                                            <div>
                                                <p class="text-white font-medium">v1.4.0 <span class="text-xs text-[#94a3b8] ml-2">Latest</span></p>
                                                <p class="text-[#94a3b8] text-sm">Catalog support, multi-threading, new scrapers (Magnet-DL, 1337x, btdigg, Torrent9), improved series matching & RD cache performance.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex items-start gap-3">
                                            <span class="w-2 h-2 mt-2 bg-[#a78bfa] rounded-full flex-shrink-0"></span>
                                            <div>
                                                <p class="text-white font-medium">v1.4.0</p>
                                                <p class="text-[#94a3b8] text-sm">HTTP streams (4KHDHub, UHDMovies), file size filter, more languages (Indian, Latino), K8S support.</p>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex items-start gap-3">
                                            <span class="w-2 h-2 mt-2 bg-[#fbbf24] rounded-full flex-shrink-0"></span>
                                            <div>
                                                <p class="text-white font-medium">v1.3.0</p>
                                                <p class="text-[#94a3b8] text-sm">Usenet support (beta), personal media file streaming, AllDebrid fixes, improved cache handling.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                            ...
                            <div class="bg-[#1e293b] rounded-2xl p-6 shadow-lg">
                                <h2 class="text-xl font-semibold text-white mb-4 flex items-center gap-2">
                                    <i class="fas fa-bolt text-[#4ac4b1]"></i>
                                    Quick Actions
                                </h2>
                                <div class="flex flex-col gap-3">
                                    <button onclick="reinstallAddon(event)" class="flex items-center gap-3 bg-[#4ac4b1] hover:bg-[#4fd4c1] text-[#0a0a0a] font-semibold px-5 py-2.5 rounded-lg transition">
                                        <i class="fas fa-sync-alt"></i>
                                        Reinstall Addon
                                    </button>
                                    <button onclick="showSection('debrid')" class="flex items-center gap-3 bg-[#334155] hover:bg-[#475569] text-white font-semibold px-5 py-2.5 rounded-lg transition">
                                        <i class="fas fa-cogs"></i>
                                        Configure Services
                                    </button>
                                    <a href="https://github.com/sooti/stremio-addon-debrid-search" target="_blank" class="flex items-center gap-3 bg-[#1e293b] hover:bg-[#334155] border border-[#334155] text-[#4ac4b1] font-semibold px-5 py-2.5 rounded-lg transition">
                                        <i class="fab fa-github"></i>
                        ...
                        <div class="mt-8 bg-gradient-to-r from-[#1e293b] to-[#334155] rounded-2xl p-6 shadow-lg flex items-center justify-between gap-6" style="height: 180px; max-height: 180px;">
                            <img src="https://spooky.host/sootiofaq.png" alt="Cute cat on laptop for FAQ" class="w-48 h-48 rounded-xl object-cover">
                            <div class="flex-1">
                                <h3 class="text-white text-2xl font-bold mb-2" style="font-size: 58px;">Need help?</h3>
                                <p class="text-[#94a3b8] text-lg" style="font-size: 27px; padding-top: 18px;">Check out the Documentation</p>
                            </div>
                            <a href="https://github.com/sooti/stremio-addon-debrid-search" target="_blank" class="bg-[#4ac4b1] hover:bg-[#4fd4c1] text-[#0a0a0a] font-semibold px-6 py-3 rounded-lg transition flex items-center gap-2 flex-shrink-0">
                ...
                <div id="filesize-section" class="section-content">
                    <div class="mb-6">
                        <h1 class="text-white text-2xl lg:text-3xl font-semibold mb-1">File Size Filter</h1>
                        <p class="text-[#8b92a7] text-sm">Set to 0-200 GB for no filtering</p>
                    </div>
    ...
    <script>
        ...
        function reinstallAddon(event) {
            ...
            if (btn && btn.tagName === 'BUTTON') {
                ...
                btn.className = btn.className.replace(/bg-\[#4ac4b1\]|hover:bg-\[#4fd4c1\]|custom-btn/g, '').trim() + ' bg-gray-600 pointer-events-none';
    ...
    <script>
        ...
        function reinstallAddon(event) {
            ...
            if (btn && btn.tagName === 'BUTTON') {
                ...
                btn.className = btn.className.replace(/bg-\[#4ac4b1\]|hover:bg-\[#4fd4c1\]/g, '').trim() + ' bg-gray-600 pointer-events-none';
