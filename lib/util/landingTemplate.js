        ...
        <div class="w-full max-w-2xl flex-1 flex items-center justify-center">
            ...
            <div id="step3" class="step-content hidden">
                <div class="max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-400 text-sm mb-8 text-center">Select torrent scrapers to search. By default, the top performing scrapers are used. More scrapers = more results but slower response times.</p>
            ...
            <div id="step4" class="step-content hidden">
                <div class="max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-400 text-sm mb-8 text-center">Select indexer scrapers. These access indexers directly. More scrapers = more results but slower response times.</p>
    ...
    <script>
        ...
        function initIndexerScrapers() {
            ...
            if (indexerScrapers.length === 0) {
                container.innerHTML = '<p class="text-gray-400 text-sm">No indexer scrapers are currently enabled on this server.</p>';
                return;
            }
        ...
        function updateLink() {
            ...
            if (indexerScrapers.length > 0) {
                config.IndexerScrapers = indexerScrapers;
            }
            ...
            config.ShowCatalog = showCatalog;
