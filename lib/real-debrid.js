        ...
        const rdHandler = {
            ...
            batchCheckSeasonPacks: async (hashes, season, episode) => {
			    ...
			    console.log(videoFiles);
                            ...
                            // Check for episode files with video validation
                            const hasEpisodeFile = files.some(file => 
                                combinedPattern.test(file.path) && 
                ...
                console.log(`[${LOG_PREFIX}] 📦 Starting batch inspection of ${hashes.length} season packs for S${season}E${episode}`);
                ...
                console.log(`[${LOG_PREFIX}] ✅ Batch inspection complete: ${validHashes.length}/${hashes.length} packs contain episode S${season}E${episode}`);
