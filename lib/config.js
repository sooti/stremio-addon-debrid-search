...
export const TORRENT_GALAXY_URL = process.env.TORRENT_GALAXY_URL || 'https://torrentgalaxy.space';
...
// Comma separated list of language tags to prefer/filter (e.g. "ita,multi,eng" or "ita").
// Supported tags: ita, eng, multi. Empty string disables filtering.
