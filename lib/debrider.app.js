...
async function checkCache(apiKey, hashes) {
    ...
    const requestFormats = [
        {
            name: 'Format 1: /link/lookup with { hashes: [...] }',
            url: `${BASE_URL}/link/lookup`,
            body: { hashes: hashes },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 2: /link/lookup with { data: [...] }',
            url: `${BASE_URL}/link/lookup`,
            body: { data: hashes },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 3: /torrents/instantAvailability',
            url: `${BASE_URL}/torrents/instantAvailability`,
            body: { hashes: hashes },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 4: /torrents/info',
            url: `${BASE_URL}/torrents/info`,
            body: { hashes: hashes },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 5: /cache/check',
            url: `${BASE_URL}/cache/check`,
            body: { hashes: hashes },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 6: /link/lookup with magnets',
            url: `${BASE_URL}/link/lookup`,
            body: { magnets: hashes.map(h => `magnet:?xt=urn:btih:${h}`) },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        },
        {
            name: 'Format 7: /link/lookup with links array',
            url: `${BASE_URL}/link/lookup`,
            body: { links: hashes.map(h => `magnet:?xt=urn:btih:${h}`) },
            headers: { 'Authorization': `Bearer ${apiKey}`, 'Content-Type': 'application/json' }
        }
    ];
