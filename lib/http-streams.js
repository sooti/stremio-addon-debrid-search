...
// NOTE: HTTP streaming results are cached via MongoDB in stream-provider.js using getCachedTorrents()
// This provides:
...
// - Cross-worker sharing: All workers share the same MongoDB cache
// - Consistent TTL: 360 minutes for movies, 60 minutes for series
console.log(`[4KHDHub] Caching is handled by MongoDB via stream-provider.js`);
