...
function extractHubCloudLinks(url, referer) {
    ...
    return makeRequest(url, { parseHTML: true })
        ...
        .then(response => {
            ...
            // Priority: pixel.hubcdn.fans > hubcdn.fans > workers.dev
            let downloadButtons = $('a[href*="pixel.hubcdn.fans"], a[href*="hubcdn.fans"], a.btn[href*="workers.dev"], a[href*="workers.dev"]');
