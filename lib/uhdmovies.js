  ...
  try {
    ...
    const streamPromises = cachedLinks.map(async (streamInfo) => {
      try {
        ...
        const langs = rawQuality.match(/\b(English|French|Spanish|German|Italian|Portuguese|Russian|Hindi|Japanese|Korean|Chinese|Arabic|Turkish|Dutch|Swedish|Norwegian|Danish|Finnish|Polish|Czech|Hungarian|Romanian|Greek|Hebrew|Thai|Tamil|Malayalam|Telugu|Kannada)\b/gi) || [];
