...
// NOTE: UHDMovies results are cached via MongoDB in stream-provider.js using getCachedTorrents()
// This provides:
...
console.log(`[UHDMovies] Caching is handled by MongoDB via stream-provider.js`);
