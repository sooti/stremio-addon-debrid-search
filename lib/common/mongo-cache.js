...
export async function initMongo() {
  ...
  initPromise = (async () => {
    ...
    // Fast lookup + ensure uniqueness per service/hash. Recreate index if options changed.
    ...
    if (existingIndex && !existingIndex.sparse) {
      console.log(`[CACHE] Dropping outdated index '${indexName}' to apply new options.`);
...
export default { upsertCachedMagnet, upsertCachedMagnets, getCachedHashes, getCachedRecord, getReleaseCounts, clearSearchCache, clearAllCache, closeMongo };
